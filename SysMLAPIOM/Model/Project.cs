...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Project : IValidatableObject
    {
        ...
        public Project(Guid id = default(Guid), TypeEnum? type = default(TypeEnum?), ProjectDefaultBranch defaultBranch = default(ProjectDefaultBranch), string description = default(string), string name = default(string))
        {
            this.Id = id;
            this.Type = type;
        ...
        public ProjectDefaultBranch DefaultBranch { get; set; }
