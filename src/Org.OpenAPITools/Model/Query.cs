...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Query : IValidatableObject
    {
        ...
        public Query(Guid id = default(Guid), TypeEnum? type = default(TypeEnum?), BranchOwningProject owningProject = default(BranchOwningProject), List<DataIdentity> scope = default(List<DataIdentity>), List<string> select = default(List<string>), Constraint where = default(Constraint))
        {
            this.Id = id;
            this.Type = type;
